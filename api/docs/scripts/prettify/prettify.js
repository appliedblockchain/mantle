...
(function() {
  function L(a) {
    function m(a) {
      var f = a.charCodeAt(0);if (f !== 92) {
        return f
      } var b = a.charAt(1);return (f = r[b]) ? f : b >= '0' && b <= '7' ? parseInt(a.substring(1), 8) : b === 'u' || b === 'x' ? parseInt(a.substring(2), 16) : a.charCodeAt(1)
    } function e(a) {
      if (a < 32) {
        return (a < 16 ? '\\x0' : '\\x') + a.toString(16)
      }a = String.fromCharCode(a);if (a === '\\' || a === '-' || a === '[' || a === ']') {
        a = '\\' + a
      } return a
    } function h(a) {
...
[], b = [], o = f[0] === '^', c = o ? 1 : 0, i = f.length;c < i;++c) {
        var j = f[c];if (/\\[bdsw]/i.test(j)) {
          a.push(j)
        } else {
          var j = m(j), d;c + 2 < i && f[c + 1] === '-' ? (d = m(f[c + 2]), c += 2) : d = j;b.push([ j, d ]);d < 65 || j > 122 || (d < 65 || j > 90 || b.push([ Math.max(65, j) | 32, Math.min(d, 90) | 32 ]), d < 97 || j > 122 || b.push([ Math.max(97, j) & -33, Math.min(d, 122) & -33 ]))
        }
      }b.sort(function(a, f) {
        return a[0] - f[0] || f[1] - a[1]
      });f = [];j = [ NaN, NaN ];for (c = 0;c < b.length;++c) {
        i = b[c], i[0] <= j[1] + 1 ? j[1] = Math.max(j[1], i[1]) : f.push(j = i)
      }b = [ '[' ];o && b.push('^');b.push(...a);for (c = 0;c <
f.length;++c) {
...
{ b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 }, n = [], p = 0, d = a.length;p < d;++p) {
    ...
    function m(a) {
      switch (a.nodeType) {
        case 1:if (e.test(a.className)) {
          break
        } for (var g = a.firstChild;g;g = g.nextSibling) {
            m(g)
          }g = a.nodeName;if (g === 'BR' || g === 'LI') {
            h[s] = '\n', t[s << 1] = y++, t[s++ << 1 | 1] = a
          } break;case 3:case 4:g = a.nodeValue, g.length && (g = p ? g.replace(/\r\n?/g, '\n') : g.replace(/[\t\n\r ]+/g, ' '), h[s] = g, t[s << 1] = y, y += g.length,
        t[s++ << 1 | 1] = a)
      }
    } var e = /(?:^|\s)nocode(?:\s|$)/, h = [], y = 0, t = [], s = 0, l;a.currentStyle ? l = a.currentStyle.whiteSpace : window.getComputedStyle && (l = document.defaultView.getComputedStyle(a, q).getPropertyValue('white-space'));var p = l && l.substring(0, 3) === 'pre';m(a);return { a: h.join('').replace(/\n$/, ''), c: t }
  } function B(a, m, e, h) {
...
'string') {
          ...
          } if ((c = b.length >= 5 && b.substring(0, 5) === 'lang-') && !(o && typeof o[1] === 'string')) {
            c = !1, b = 'src'
          }c || (r[f] = b)
        }i = d;d += f.length;if (c) {
          c = o[1];var j = f.indexOf(c), k = j + c.length;o[2] && (k = f.length - o[2].length, j = k - c.length);b = b.substring(5);B(l + i, f.substring(0, j), e, p);B(l + i + j, c, C(b, c), p);B(l + i + k, f.substring(k), e, p)
        } else {
          p.push(l + i, b)
        }
      }a.e = p
    ...
    function e(a) {
      switch (a.nodeType) {
        case 1:if (k.test(a.className)) {
          ...
          } break;case 3:case 4:if (p) {
          var b = a.nodeValue, d = b.match(t);if (d) {
      ...
      function b(a, d) {
        var e = d ? a.cloneNode(!1) : a, f = a.parentNode;if (f) {
          var f = b(f, 1), g = a.nextSibling;f.appendChild(e);for (var h = g;h;h = g) {
    ...
    } var k = /(?:^|\s)nocode(?:\s|$)/, t = /\r\n?|\n/, s = a.ownerDocument, l;a.currentStyle ? l = a.currentStyle.whiteSpace : window.getComputedStyle && (l = s.defaultView.getComputedStyle(a, q).getPropertyValue('white-space'));var p = l && l.substring(0, 3) === 'pre';for (l = s.createElement('LI');a.firstChild;) {
      l.appendChild(a.firstChild)
    } for (var d = [ l ], g = 0;g < d.length;++g) {
      e(d[g])
    }m === (m | 0) && d[0].setAttribute('value',
      m);var r = s.createElement('OL');r.className = 'linenums';for (var n = Math.max(0, m - 1 | 0) || 0, g = 0, z = d.length;g < z;++g) {
    ...
    var m =
a.g;try {
      var e = M(a.h), h = e.a;a.a = h;a.c = e.c;a.d = 0;C(m, h)(a);var k = /\bMSIE\b/.test(navigator.userAgent), m = /\n/g, t = a.a, s = t.length, e = 0, l = a.c, p = l.length, h = 0, d = a.e, g = d.length, a = 0;d[g] = s;var r, n;for (n = r = 0;n < g;) {
...
!k) {
    ...
    } var e = q, l = Date;l.now || (l = { now: function() {
      return +new Date
